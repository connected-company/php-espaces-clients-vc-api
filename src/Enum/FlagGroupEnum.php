...
class FlagGroupEnum extends ReadableEnum
{
    ...
    const DOCUMENTS_APPEL_FOND_PHOTO = 'documents_appel_fond_photo';
    ...
    public static function choices(): array
    {
        return [
            ...
            static::DOCUMENTS_APPEL_FOND_PHOTO => 'documents_appel_fond_photo',
    ...
    public static function mapping(FlagGroupEnum $flagGroup): array
    {
        $mapping = [
            ...
            self::DOCUMENTS_APPEL_FOND_PHOTO => [
